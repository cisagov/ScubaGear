...
- [ ] Review draft release notes generated by the `Build and Draft Release` workflow
  - Notes are grouped via `.github/release.yml` into Major Changes, Bugs Fixed, Baselines, Documentation, and Dependencies
  - Edit notes as needed before publishing (for example, add BOD 25-01 baseline guidance, "See full list" links, or trim long sections)
