...
# Policy 8
#--
# test_AllowedSenderDomainsNotEmpty_Correct if {
#     ControlNumber := "Defender 2.6"
...
# test_AllowedSenderDomainsNotEmpty_Incorrect if {
#     ControlNumber := "Defender 2.6"
#     Requirement := "Allowed senders MAY be added but allowed domains SHALL NOT be added: default policy"
...
#     count(RuleOutput) == 1
#     not RuleOutput[0].RequirementMet
#     RuleOutput[0].ReportDetails == "1 custom anti-spam policy(ies) found where there is at least one allowed sender domain: Default"
# }

# test_AllowedSenderDomainsNotEmptyCustom_Correct if {
#     ControlNumber := "Defender 2.6"
...
# test_AllowedSenderDomainsNotEmptyCustom_Incorrect if {
#     ControlNumber := "Defender 2.6"
#     Requirement := "Allowed senders MAY be added but allowed domains SHOULD NOT be added: non-default"
...
#     count(RuleOutput) == 1
#     not RuleOutput[0].RequirementMet
#     RuleOutput[0].ReportDetails == "1 custom policy(ies) found where there is at least one allowed sender domain: Not Default"
# }