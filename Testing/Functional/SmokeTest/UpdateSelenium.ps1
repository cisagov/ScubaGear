...
Write-Debug -Message "$(Join-Path -Path $webDriversPath -ChildPath '/WindowsPowerShell/Modules/Selenium')"
Write-Debug -Message "$(Join-Path -Path $webDriversPath -ChildPath '/WindowsPowerShell/Modules/Selenium/3.0.1/assemblies')"
