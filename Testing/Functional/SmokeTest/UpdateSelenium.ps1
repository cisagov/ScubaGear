...
param (
    ...
    $webDriversPath      = "$([Environment]::GetFolderPath('MyDocuments'))\Documents\WindowsPowerShell\Modules\Selenium\3.0.1\assemblies",  # local path for all web drivers (assuming that both are in the same location)
