...
param (
    ...
    [ValidateSet('AAD', 'SecuritySuite', 'EXO', 'PowerPlatform', 'Sharepoint', 'Teams', 'PowerBI', '*')]
    [Alias('p')]
    [string[]]$Products = '*',
...
if ($pEmpty) {
    Invoke-Products -Flag $Flag -Products @('AAD', 'SecuritySuite', 'EXO', 'PowerPlatform', 'Sharepoint', 'Teams', 'PowerBI')
}
