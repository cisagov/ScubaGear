<#
    ...
    .DESCRIPTION
        ...
        provider that is being regression tested based on the product name designation used in ScubaGear.  These include entraid,
        ...
        EXAMPLE
            - ENTRAIDProviderExport-contoso-01052023
            - ENTRAIDTestResults-contoso-01052023
    ...
    .EXAMPLE
        .\RunFunctionalTests.ps1 -p teams,exo,defender,entraid
        Runs all test cases for specified products. Products must be specified with -p parameter.
        Valid product names are: entraid, defender, exo, onedrive, powerplatform, sharepoint, teams, and '*'.
...
param (
    <#
        .PARAMETER Products
            ...
            against: 'teams', 'exo', 'defender', 'entraid', 'powerplatform', 'sharepoint', 'onedrive', '*'. Runs all on default.
        #>
...
function Write-RegoOutput {
    param (
        [Parameter(Mandatory)]
        [ValidateNotNullOrEmpty()]
        [ValidateSet('entraid', 'defender', 'exo', 'onedrive', 'powerplatform', 'sharepoint', 'teams', '*', IgnoreCase = $false)]
        [string[]]$Products,
