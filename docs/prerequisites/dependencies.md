...
|:---------------------------------------------:|:---------------:|:----------------:|:---------------------------------------------|
| MicrosoftTeams |           4.9.3 |            7.9.0 | Microsoft Teams configuration management |
...
[![OPA Tested Version](https://img.shields.io/badge/SCuBA%20OPA%20Tested%20Version-v1.19.0-green)](https://github.com/open-policy-agent/opa/releases/tag/v1.19.0)
