...
<!--Policy: MS.ME-ID.1.1v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.2.1v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.2.2v1; Criticality: SHOULD -->
...
<!--Policy: MS.ME-ID.2.3v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.3.1v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.3.2v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.3.3v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.3.4v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.3.5v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.3.6v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.3.7v1; Criticality: SHOULD -->
...
<!--Policy: MS.ME-ID.3.8v1; Criticality: SHOULD -->
...
<!--Policy: MS.ME-ID.5.1v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.5.2v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.5.3v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.5.4v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.6.1v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.7.1v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.7.2v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.7.3v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.7.5v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.7.6v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.7.7v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.7.8v1; Criticality: SHALL -->
...
<!--Policy: MS.ME-ID.7.9v1; Criticality: SHOULD -->
...
1. Follow the instructions for policy MS.ME-ID.7.1v1 above to get a count of users assigned to the Global Administrator role.

2. Follow the instructions for policy MS.ME-ID.7.1v1 above but get a count of users assigned to the other highly privileged roles (not Global Administrator). If a user is assigned to both Global Administrator and other roles, only count that user for the Global Administrator assignment.
...
#### MS.ME-ID.7.9v1 Instructions

 1. Follow the same instructions as MS.ME-ID.7.8v1 for each of the highly privileged roles (other than Global Administrator) but enter a security monitoring mailbox different from the one used to monitor Global Administrator activations.
...
<!--Policy: MS.ME-ID.8.2v1; Criticality: SHOULD -->
...
<!--Policy: MS.ME-ID.8.3v1; Criticality: SHOULD -->
