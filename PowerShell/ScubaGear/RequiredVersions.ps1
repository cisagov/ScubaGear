...
$MsalDependency = @{
    ...
    # file name written to the cache (all flattened into the net462 target folder).
    Packages = @(
        ...
        @{ Id = 'System.ValueTuple';                       Version = '4.5.0';  Sha256 = '9E21FA9767D4E76BC0CEE065C1D40CC34384A114BFEC4D70E6C981168A926802'; LibPath = 'lib/net461/System.ValueTuple.dll';                       TargetDll = 'System.ValueTuple.dll' }
        @{ Id = 'System.Text.Json';                        Version = '6.0.10'; Sha256 = '5228D88747711631629CC3D24C9A1BF7AA1A464366F96B1AFBB15F83A9919EC7'; LibPath = 'lib/net461/System.Text.Json.dll';                        TargetDll = 'System.Text.Json.dll' }
        @{ Id = 'System.Text.Encodings.Web';               Version = '6.0.0';  Sha256 = '51E9831C61684081BB39B430465BA155FE8082D42291F1C4A0F2C2EA06C5C91A'; LibPath = 'lib/net461/System.Text.Encodings.Web.dll';               TargetDll = 'System.Text.Encodings.Web.dll' }
        @{ Id = 'System.Formats.Asn1';                     Version = '8.0.1';  Sha256 = '99ACBF5A0F9EB269B5375E244131B81123018BE19028FA7466BAC1A3FA3A3973'; LibPath = 'lib/net462/System.Formats.Asn1.dll';                     TargetDll = 'System.Formats.Asn1.dll' }
        @{ Id = 'System.Memory';                           Version = '4.5.5';  Sha256 = '10F43DA352A29FB2B3188E4EDD4DCF5100194C8B526E4F61FE2E2B5623775A22'; LibPath = 'lib/net461/System.Memory.dll';                           TargetDll = 'System.Memory.dll' }
        @{ Id = 'System.Buffers';                          Version = '4.5.1';  Sha256 = 'C30B3DD2C7E2F4CEE4B823D692FD42118309B42AB1F5007F923D329A5B0D6B12'; LibPath = 'lib/net461/System.Buffers.dll';                          TargetDll = 'System.Buffers.dll' }
        @{ Id = 'System.Numerics.Vectors';                 Version = '4.5.0';  Sha256 = 'A9D49320581FDA1B4F4BE6212C68C01A22CDF228026099C20A8EABEFCF90F9CF'; LibPath = 'lib/net46/System.Numerics.Vectors.dll';                  TargetDll = 'System.Numerics.Vectors.dll' }
        @{ Id = 'System.Threading.Tasks.Extensions';       Version = '4.5.4';  Sha256 = 'A304A963CC0796C5179F9C6B7D8022BBCE3B2FA7C029EB6196F631F7B462D678'; LibPath = 'lib/net461/System.Threading.Tasks.Extensions.dll';       TargetDll = 'System.Threading.Tasks.Extensions.dll' }
        @{ Id = 'Microsoft.Bcl.AsyncInterfaces';           Version = '6.0.0';  Sha256 = 'E3DF87FE2170A7E01F0880AF59CAA8F6EB380B3C40A4F282DFB43912AAF0F895'; LibPath = 'lib/net461/Microsoft.Bcl.AsyncInterfaces.dll';           TargetDll = 'Microsoft.Bcl.AsyncInterfaces.dll' }
    )
