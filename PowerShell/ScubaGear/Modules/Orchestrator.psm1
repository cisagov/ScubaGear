...
# Override the default individual report folder name if needed
...
"@
            ...
            foreach ($Product in $ScubaConfig.ProductNames) {
                # Get the baseline name for the current product using the ScubaConfig class.
    ...
    process {
        try {
            ...
            foreach ($ProductName in $ProductNames) {
                # Get the baseline name and display name for the current product using the ScubaConfig class.
                $BaselineName = [ScubaConfig]::GetProductBaselineName($ProductName)
                # Get the display name for the current product using the ScubaConfig class.
