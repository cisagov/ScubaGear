...
function Export-PowerBIProvider {
    ...
    # License not found, return JSON with license status and empty settings
    else {
        ...
        # We must mark Invoke-RestMethod as successful even if we don't call it. The absence of a license is not an error and the Rego knows how to handle it.
