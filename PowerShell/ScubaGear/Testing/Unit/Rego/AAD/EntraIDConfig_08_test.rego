...
test_GuestUserRoleId_Correct_V1 if {
    ...
    TestResult("MS.ENTRAID.8.1v1", Output, ReportDetailString, true) == true
}
...
test_GuestUserRoleId_Incorrect_V1 if {
    ...
    TestResult("MS.ENTRAID.8.1v1", Output, ReportDetailString, false) == true
}
...
test_AllowInvitesFrom_Correct if {
    ...
    TestResult("MS.ENTRAID.8.2v1", Output, ReportDetailString, true) == true
}
...
test_AllowInvitesFrom_Incorrect if {
    ...
    TestResult("MS.ENTRAID.8.2v1", Output, ReportDetailString, false) == true
}
#--

#
# Policy MS.ENTRAID.8.3v1
#--
