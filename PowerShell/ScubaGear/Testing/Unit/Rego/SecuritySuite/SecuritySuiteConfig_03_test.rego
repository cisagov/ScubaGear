...
import data.utils.securitysuite.DLPLICENSEWARNSTR

#
# MS.SECURITYSUITE.3.1v1
#--
test_ContentContainsSensitiveInformation_Correct_V1 if {
    Output := securitysuite.tests with input.dlp_compliance_rules as [DlpComplianceRules]
    ...
    TestResult("MS.SECURITYSUITE.3.1v1", Output, PASS, true) == true
}
...
test_ContentContainsSensitiveInformation_Incorrect_V1 if {
    ...
    TestResult("MS.SECURITYSUITE.3.1v1", Output, ReportDetailString, false) == true
}
...
test_NoDLPLicense_Incorrect_3_1_V1 if {
...
test_Locations_Correct_V1 if {
    ...
    TestResult("MS.SECURITYSUITE.3.2v1", Output, PASS, true) == true
}
...
test_Locations_Correct_V3 if {
    ...
    Output := securitysuite.tests with input.dlp_compliance_rules as [DlpComplianceRules, DlpComplianceRule]
...
test_Locations_Incorrect_V1 if {
    ...
    TestResult("MS.SECURITYSUITE.3.2v1", Output, ReportDetailString, false) == true
}
...
test_NoDLPLicense_Incorrect_3_2_V1 if {
    Output := securitysuite.tests with input.defender_license as false
                            with input.defender_dlp_license as false
...
test_BlockAccess_Correct_V1 if {
    ...
    TestResult("MS.SECURITYSUITE.3.3v1", Output, PASS, true) == true
}
...
test_BlockAccess_Incorrect_V1 if {
    ...
    TestResult("MS.SECURITYSUITE.3.3v1", Output, ReportDetailString, false) == true
}
...
test_BlockAccess_Incorrect_V5 if {
    ...
    Output := securitysuite.tests with input.dlp_compliance_rules as [DlpComplianceRule1, DlpComplianceRule2]
                            with input.dlp_compliance_policies as [DlpCompliancePolicies]
                            with input.scuba_config as ScubaConfig
                            with input.defender_license as true
                            with input.defender_dlp_license as true
...
test_NoDLPLicense_Incorrect_3_3_V1 if {
    Output := securitysuite.tests with input.defender_license as false
                            with input.defender_dlp_license as false
...
test_NotifyUser_Correct_V1 if {
    ...
    TestResult("MS.SECURITYSUITE.3.4v1", Output, PASS, true) == true
}
...
test_NotifyUser_Incorrect_V1 if {
    ...
    ReportDetailString := "No DLP policy matching all types found for evaluation."
    TestResult("MS.SECURITYSUITE.3.4v1", Output, ReportDetailString, false) == true
}
...
test_NoDLPLicense_Incorrect_3_4_V1 if {
    Output := securitysuite.tests with input.defender_license as false
                            with input.defender_dlp_license as false
...
test_UnallowedAppsAndBluetooth_Incorrect_V2 if {
    ...
    DlpComplianceRuleBluetooth := json.patch(DlpComplianceRules,
                                [{"op": "add", "path": "Name", "value": "Rule blocking Bluetooth only"},
                                {"op": "add", "path": "EndpointDlpRestrictions", "value": [
                                    {"setting": "UnallowedApps", "value": "Audit"},
                                    {"setting": "UnallowedBluetoothTransferApps", "value": "Block"}
                                ]}])

    Output := securitysuite.tests with input.dlp_compliance_rules as [
                                DlpComplianceRuleApps,
