...
InModuleScope CreateReport {
    ...
    Describe -tag "Markdown" -name 'Check error handling.' {
        ...
        It "Check not throw an exception with malformed baseline" {
            {
                Import-SecureBaseline -ProductNames "aad" -BaselinePath "PowerShell/ScubaGear/Testing/Unit/PowerShell/CreateReport/CreateReportStubs"
            } | Should -Not -Throw
        }
        ...
        It "Check MS.AAD.1.1v1 for malformed" {
            $Output = Import-SecureBaseline -ProductNames "aad" -BaselinePath "PowerShell/ScubaGear/Testing/Unit/PowerShell/CreateReport/CreateReportStubs"
