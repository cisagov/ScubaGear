...
Description = 'The Secure Cloud Business Applications (SCuBA) Gear module automates
...
ScriptsToProcess = './RaiseFunctionCap.ps1', './Dependencies.ps1'
...
FunctionsToExport = 'Invoke-SCuBA', 'Invoke-RunCached', 'Disconnect-SCuBATenant', 
               'Copy-ScubaBaselineDocument', 'Install-OPA', 'Initialize-SCuBA', 
               'Debug-SCuBA', 'Copy-ScubaSampleReport', 'Copy-ScubaSampleConfigFile', 
               'New-Config'
